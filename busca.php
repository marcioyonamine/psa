...
<br /><br />
	...
	<br /><Br />
			...
			<div class="col-md-offset-1 col-md-10">
			 <?php 
			 $sql_ped = "SELECT DISTINCT idPedidoContratacao FROM sc_contratacao, sc_evento WHERE sc_contratacao.publicado = '1' AND tipoPessoa = '2' AND idPessoa = '".$_GET['id']."' AND dataEnvio IS NOT NULL";
