...
?>
  ...
  <?php include "menu/me_contatos.php"; ?>
...
<section id="contact" class="home-section bg-white">
    <div class="container">
		...
		<?php 
		$sql_contatos = "SELECT * FROM sc_contatos ORDER BY nome ASC";
...
<section id="contact" class="home-section bg-white">
 ...
 $contato = recuperaDados("sc_contatos",$_POST['editar'],"id");
...
$contato = recuperaDados("sc_contatos",$_POST['atualizar'],"id");
				...
				<form method="POST" action="?p=editar" class="form-horizontal" role="form">
					<div class="row">
						<div class="col-12">
							...
							<input type="text" name="nome" class="form-control" id="inputSubject" value="<?php echo $contato['nome'] ?>"/>
						</div>
					</div>
					<br />
					<div class="row">
						<div class="col-12">
							...
							<input type="text" name="nomeartistico" class="form-control" id="inputSubject" value="<?php echo $contato['nome_artistico'] ?>"/>
						</div>
					</div>
					<br />
					...
					<div class="row">
						<div class="col-6">
							...
							<input type="text" class="form-control" name="localnascimento" value="<?php echo $contato['local'] ?>"> 
						</div>						<div class="col-6">
							<label>Data de Nascimento</label>
							<input type="text" class="form-control calendario" name="datanascimento" value="<?php echo exibirDataBr($contato['nascimento']) ?>"> 
						</div>
					</div>	
					<br />
					<div class="row">
						<div class="col-6">
							<label>CEP</label>
							<input type="text" class="form-control cep" name="cep" id="CEP" value="<?php echo $contato['cep'] ?>"> 
						</div>
						<div class="col-6">
							<label>Número</label>
							<input type="text" class="form-control" name="numero" value="<?php echo $contato['numero'] ?>" > 
						</div>
					</div>	
					<br />
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-6">
							...
							<input type="text" class="form-control" name="complemento" value="<?php echo $contato['complemento'] ?>"> 
						</div>
					</div>	
					<br />
					<div class="row">
					...
					<br />					
						...
						<div class="col-6">
							...
							<input type="text" class="form-control" name="telefone1" value="<?php echo $contato['telefone1'] ?>"> 
						</div>
						<div class="col-6">
							<label>Telefone 02</label>
							<input type="text" class="form-control" name="telefone2" value="<?php echo $contato['telefone2'] ?>"> 
						</div>
					</div>	
					<br />
					<div class="row">
						<div class="col-6">
							...
							<input type="text" class="form-control" name="telefone3" value="<?php echo $contato['telefone3'] ?>"> 
						</div>
						<div class="col-6">
							<label>E-mail</label>
							<input type="text" class="form-control" name="email" value="<?php echo $contato['email'] ?>"> 
						</div>
					</div>	
					<br />
					<div class="row">
						<div class="col-12">
							<label>Biografia / Relato</label>
								<textarea name="biografia" class="form-control" rows="10" ><?php echo $contato['bio'] ?></textarea>					
						</div>
					</div>
					<br />	
					...
					<div class="row">
						<div class="col-12">
							<label>Área de atuação </label>
								<textarea name="area_atuacao" class="form-control" rows="10" ><?php echo $contato['area'] ?></textarea>					
						</div>
					</div>
					<br />
					<div class="row">
						<div class="col-12">
							<label>Local de atuação </label>
								<textarea name="local_atuacao" class="form-control" rows="10" ><?php echo $contato['local_atuacao'] ?></textarea>					
						</div>
					</div>
					<br />				
					<div class="row">
						<div class="col-12">
							<label>Acervo </label>
								<textarea name="acervo" class="form-control" rows="10" ><?php echo $contato['acervo'] ?></textarea>					
						</div>
					</div>
					<br />		
					<div class="row">
						<div class="col-12">
							<label>Links </label>
								<textarea name="links" class="form-control" rows="10" ><?php echo $contato['links'] ?></textarea>					
						</div>
					</div>
					<br />		
										<div class="row">
						<div class="col-12">
							...
							<input type="text" name="culturaz" class="form-control" id="inputSubject" value="<?php echo $contato['culturaz'] ?>"/>
						</div>
					</div>
					<br />
