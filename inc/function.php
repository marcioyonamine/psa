...
function somaPrograma($id){
	global $wpdb;
	$total = 0;
	$sql_evento = "SELECT valor FROM sc_contratacao WHERE idEvento IN(SELECT idEvento FROM sc_evento WHERE idPrograma = '$id' AND publicado = '1' AND dataEnvio <> NULL AND cancelamento = 0) AND nLiberacao <> '' AND publicado ='1'";
