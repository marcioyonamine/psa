...
?>
  ...
  <?php include "menu/me_percurso.php"; ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                    ...
                    <h3>Percurso/Formação</h3>
                    <h1></h1>
                    <h4><?php if(isset($mensagem)){ echo $mensagem;} ?></h4>
					<p>Módulo para acompanhamento pedagógico.</p>	
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
				...
				global $wpdb;
				$id_user = $user->ID;
				$sql_list =  "SELECT * FROM per_alunos ORDER BY nome ASC";
				...
				for($i = 0; $i < count($res); $i++){
					...
					<tr>
					  ...
					  <td>	
							<form method="POST" action="percurso.php?p=editar_aluno" class="form-horizontal" role="form">
							<input type="hidden" name="editar" value="<?php echo $res[$i]['id']; ?>" />
