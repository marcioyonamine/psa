          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
				...
				$sql_seleciona = "SELECT * FROM sc_contratacao WHERE publicado = '1' AND (idEvento IN (SELECT idEvento FROM sc_evento WHERE dataEnvio IS NOT NULL AND (status = '3' OR status = '4') AND cancelamento = '0') OR idAtividade <> '0') AND (valor <> '0' AND valor IS NOT NULL) AND (dotacao IS NOT NULL AND dotacao <> '0') $f ORDER BY nLiberacao DESC";
