...
if(isset($_POST['duplicar'])){
	$sql_apaga = "INSERT INTO `sc_contratacao` (`idEvento`, `idAtividade`, `tipoPessoa`, `idRepresentante01`, `idPessoa`, `integrantesGrupo`, `valor`, `valorPorExtenso`, `formaPagamento`, `dotacao`, `anexo`, `observacao`, `publicado`, `valorIndividual`, `idRepresentante02`, `instituicao`, `executante`, `NumeroProcesso`, `NumeroNotaEmpenho`, `DataEmissaoNotaEmpenho`, `DataEntregaNotaEmpenho`, `IdUsuarioContratos`, `IdAssinatura`, `IdExecutante`, `justificativa`, `parecerArtistico`, `estado`, `aprovacaoFinanca`, `parcelas`, `idContratos`, `idDetalhamentoAcao`, `DataProposta`, `DataReserva`, `DataContrato`, `AmparoLegal`, `ComplementoDotacao`, `Finalizacao`, `idPenalidade`, `DataJuridico`, `DataPublicacao`, `DataContabilidade`, `DataPagamento`, `nProcesso`, `extratoLiquidacao`, `retencoesINSS`, `retencoesISS`, `retencoesIRRF`, `notaFiscal`, `descricaoNF`, `qtdApresentacoes`, `planejamento`,  `mov_orc`) SELECT `idEvento`, `idAtividade`, `tipoPessoa`, `idRepresentante01`, `idPessoa`, `integrantesGrupo`, `valor`, `valorPorExtenso`, `formaPagamento`, `dotacao`, `anexo`, `observacao`, `publicado`, `valorIndividual`, `idRepresentante02`, `instituicao`, `executante`, `NumeroProcesso`, `NumeroNotaEmpenho`, `DataEmissaoNotaEmpenho`, `DataEntregaNotaEmpenho`, `IdUsuarioContratos`, `IdAssinatura`, `IdExecutante`, `justificativa`, `parecerArtistico`, `estado`, `aprovacaoFinanca`, `parcelas`, `idContratos`, `idDetalhamentoAcao`, `DataProposta`, `DataReserva`, `DataContrato`, `AmparoLegal`, `ComplementoDotacao`, `Finalizacao`, `idPenalidade`, `DataJuridico`, `DataPublicacao`, `DataContabilidade`, `DataPagamento`, `nProcesso`, `extratoLiquidacao`, `retencoesINSS`, `retencoesISS`, `retencoesIRRF`, `notaFiscal`, `descricaoNF`, `qtdApresentacoes`, `planejamento`,   `mov_orc` FROM sc_contratacao WHERE idPedidoContratacao = '".$_POST['duplicar']."'";
	$query_apaga = $wpdb->query($sql_apaga);
	if($query_apaga == 1){
...
<h1> Editar Pedido</h1>
		...
		<form method="POST" action="?p=editar_pedido" class="form-horizontal" role="form">
				...
				<form action="arquivo.php?p=inserir&tipo=302&id=<?php echo $id_pedido; ?>" method="post">
					...
					<div class="row">
						<div class="col-12">
					<a  class="btn btn-theme btn-lg btn-block" href="documentos.php?modelo=561&id=<?php echo $id_pedido?>" target="_blank">OS para pedido de contratação FIP 2018</a>
						</div>
					</div>						
					<div class="row">
						<div class="col-12">
